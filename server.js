// server.js - Full Complete Version with Simple Telegram Bot
...
// ============ SIMPLE TELEGRAM BOT ============
// Direct require - no class, no constructor
...
async function startServer() {
    try {
        ...
        app.listen(PORT, async () => {
            ...
            try {
                await ChannelSender.testChannels();
            } catch (error) {
                console.log('⚠️ Channel test:', error.message);
            }
        });
